  ...
  return (
    <div className="min-h-screen bg-[#F7F5F0]">
      ...
      <header className="bg-brand-green text-white px-5 py-3 flex items-center gap-3 sticky top-0 z-50 shadow-md">
        ...
        <h1 className="text-base font-bold tracking-wide">🏪 門市使用導覽</h1>
      </header>
      ...
      <main className="max-w-[520px] mx-auto px-4 py-5 space-y-6">
        ...
        <section>
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-sm font-bold text-[#2C2C2C]">門市物品擺放位置</h2>
          </div>
            ...
            {LOCATIONS.map((loc, idx) => (
              ...
              >
                ...
                <div className="px-4 py-3 flex items-center gap-3 border-b border-[#F0EDE9]">
                  ...
                  {loc.images.length > 1 && (
                    <span className="ml-auto text-[10px] text-[#999] shrink-0">
                      左右滑動 {loc.images.length} 張
                    </span>
                  )}
                </div>
                {/* Image */}
